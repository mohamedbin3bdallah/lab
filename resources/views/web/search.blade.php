					...
					@foreach ($alldata as $data)
                     <div class="col-sm-4">
					   <div class="card" style="width:100%">
							@if ($data->flag == 1) <center><img class="card-img-top" src="{{url('uploads/products/'.$data->image)}}"" alt="Card image" style="width:50%"></center>
							@else <center><img class="card-img-top" src="{{url('uploads/solutions/'.$data->image)}}"" alt="Card image" style="width:50%"></center>
							@endif
							...
							<div class="card-body">
							  ...
							  <p class="card-text" style="color:white;">{{(strlen($data->brief) > 75)? substr($data->brief,0,strpos($data->brief,' ',70)):$data->brief}}</p>
