...
<html lang="en">
<head>
<title>{{__('lab.branch_login')}}</title>
<meta charset="utf-8">
...
{{$body->content}}
				...
				<div class="col-lg-6 boxes_col">
					...
					<div class="img working_hours">
						<div class="img d-flex flex-column align-items-start justify-content-center">
						 <div class="section_title"><h2>{{__('lab.branch_login')}}</h2></div>
 <div class="contact_form_container">
						...
						<form class="contact_form" method="POST" action="{{ url('branch_login') }}">
                        {{ csrf_field() }}
