...
<div class="sidebar">
 ...
 <p style="color:white;">{{$lab->name}} Lab</p>
  ...
  @if(session('type')=='labs')<a class="active" href="{{url('lab/'.session('id').'/patients')}}"><i class="fa fa-users" aria-hidden="true"></i> Patients List</a>
 
  @elseif(session('type')=='branches')<a class="active" href="{{url('lab/'.$lab_id.'/patients')}}"><i class="fa fa-users" aria-hidden="true"></i> Patients List</a>@endif
